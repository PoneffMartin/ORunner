...
public class ZoomableMapPhoto extends View {
    private static final String TAG = ZoomableMapPhoto.class.getSimpleName();
    ...
    public ZoomableMapPhoto(Context context) {
        super(context);
        setFocusable(true);
        ...
        initPaints();
        gestureDetector = new android.view.GestureDetector(new GestureDetector());
    }

    public ZoomableMapPhoto(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        defaultScale = ZoomableMapPhoto.DEFAULT_SCALE_FIT_INSIDE;
    }
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        if(imgBitmap != null) {
            ...
            if(defaultScale == ZoomableMapPhoto.DEFAULT_SCALE_FIT_INSIDE) {
